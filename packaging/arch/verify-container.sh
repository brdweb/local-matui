...
cp /work/PKGBUILD /work/ma-tui /work/ma-tui.desktop /work/README.md /work/INSTALL.txt /work/THIRD-PARTY-NOTICES.tar.gz /work/DEVELOPMENT-STATUS /work/LICENSE /tmp/ma-tui-build/
